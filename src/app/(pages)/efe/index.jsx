...
export default function EfePage() {
  ...
  return (
    <FactorView
      title="Matriz EFE (Evaluación de Factores Externos)"
      subtitle="Evaluación de factores externos"
      description="La ponderación expresa el peso del entorno. La calificación mide la respuesta organizacional ante cada oportunidad o amenaza."
      factors={state.external}
      total={analysis.efe.total}
      weightTotal={analysis.efe.weightTotal}
      group="external"
