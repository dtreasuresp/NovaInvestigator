...
const MailNav = ({
  ...
  return (
    <div className='flex flex-1 flex-col gap-4 overflow-auto p-3 max-lg:pt-0'>
      <div>
        <p className='text-muted-foreground px-2 pb-2.5 text-[11px] font-medium uppercase'>{t('mail.mailboxes')}</p>
      ...
      <div>
        <p className='text-muted-foreground px-2 pb-2.5 text-[11px] font-medium uppercase'>{t('mail.labels')}</p>
        <nav className='grid gap-1'>
