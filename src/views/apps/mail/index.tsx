                ...
                <div className='flex items-center gap-2 px-3'>
                  <InputGroup className='relative flex-1'>
                    <InputGroupAddon>
                      ...
                      <span className='sr-only'>{t('datatables.search')}</span>
                    </InputGroupAddon>
                    <InputGroupInput
                      type='search'
                  ...
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent align='end'>
                      <DropdownMenuItem>{t('mail.defaultOrder')}</DropdownMenuItem>
                      <DropdownMenuItem>{t('mail.newestFirst')}</DropdownMenuItem>
                      <DropdownMenuItem>{t('mail.oldestFirst')}</DropdownMenuItem>
                    </DropdownMenuContent>
                  </DropdownMenu>
                </div>
