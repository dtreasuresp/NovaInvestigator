  ...
  return (
    <Card className='gap-0 py-0'>
      <CardHeader className='border-b px-6 py-4'>
        <CardTitle className='text-base'>{t('notifications.notifications')}</CardTitle>
        <p className='text-muted-foreground text-sm'>
          Selecciona cómo {user.name} recibe las notificaciones de actividad.
        </p>
      </CardHeader>
        ...
        <Table>
          <TableHeader>
            <TableRow className='hover:bg-transparent'>
              <TableHead className='text-muted-foreground pl-6'>{t('notifications.type')}</TableHead>
            ...
            {settings.length === 0 ? (
              <TableRow className='hover:bg-transparent'>
                <TableCell colSpan={4} className='text-muted-foreground py-8 text-center text-sm'>
                  No se encontraron configuraciones de notificación.
                </TableCell>
              </TableRow>
            ) : (
