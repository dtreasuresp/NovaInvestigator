        ...
        <form onSubmit={form.handleSubmit(handleSubmit)} className='flex flex-col gap-4 px-4 pb-4'>
          <FieldGroup className='gap-4'>
            <Controller
              ...
              render={({ field, fieldState }) => (
                <Field data-invalid={fieldState.invalid} className='gap-2'>
                  ...
                  <Input {...field} id={field.name} placeholder={t('forms.namePlaceholder') || 'Nombre completo'} aria-invalid={fieldState.invalid} />
              ...
              render={({ field, fieldState }) => (
                <Field data-invalid={fieldState.invalid} className='gap-2'>
                  ...
                  <Input
                    ...
                    id={field.name}
                    type='email'
                    placeholder={t('forms.emailPlaceholder') || 'usuario@empresa.com'}
            ...
            <Controller
              ...
              render={({ field, fieldState }) => (
                <Field data-invalid={fieldState.invalid} className='gap-2'>
                  <FieldLabel htmlFor={field.name}>{t('forms.phone') || 'Contacto'}</FieldLabel>
                  <Input
                    {...field}
                    id={field.name}
                    type='tel'
            ...
            <Controller
              ...
              render={({ field, fieldState }) => (
                <Field data-invalid={fieldState.invalid} className='gap-2'>
                  ...
                  <Input {...field} id={field.name} placeholder={t('forms.company')} aria-invalid={fieldState.invalid} />
                  {fieldState.invalid ? <FieldError errors={[fieldState.error]} /> : null}
                </Field>
              )}
            />
            ...
            <Controller
              ...
              render={({ field, fieldState }) => (
                <Field data-invalid={fieldState.invalid} className='gap-2'>
                  <FieldLabel htmlFor='country'>{t('forms.country')}</FieldLabel>
                  <Select value={field.value} onValueChange={field.onChange}>
                    <SelectTrigger id='country' className='w-full'>
                      <SelectValue placeholder={t('forms.countryPlaceholder')} />
                    </SelectTrigger>
            ...
            <Controller
              ...
              render={({ field, fieldState }) => (
                <Field data-invalid={fieldState.invalid} className='gap-2'>
                  <FieldLabel htmlFor='role'>{t('roles.customRoles')}</FieldLabel>
                  <Select value={field.value} onValueChange={field.onChange}>
                    <SelectTrigger id='role' className='w-full'>
                      <SelectValue placeholder={t('users.selectRole') || 'Seleccionar rol'} />
                    </SelectTrigger>
                    <SelectContent alignItemWithTrigger={false}>
                      <SelectGroup>
                        {ROLES.map(role => (
            ...
            <Controller
              ...
              render={({ field, fieldState }) => (
                <Field data-invalid={fieldState.invalid} className='gap-2'>
                  <FieldLabel htmlFor='plan'>{t('platform.entitlementPlan')}</FieldLabel>
                  <Select value={field.value} onValueChange={field.onChange}>
                    <SelectTrigger id='plan' className='w-full'>
                      <SelectValue placeholder={t('platform.commercialPlans') || 'Seleccionar plan'} />
                    </SelectTrigger>
                    <SelectContent alignItemWithTrigger={false}>
                      <SelectGroup>
                        {PLANS.map(plan => (
                ...
                <Field data-invalid={fieldState.invalid} className='gap-2'>
                  ...
                  <Select value={field.value} onValueChange={field.onChange}>
                    <SelectTrigger id='status' className='w-full'>
                      <SelectValue placeholder={t('users.selectStatus') || 'Seleccionar estado'} />
                    </SelectTrigger>
                    <SelectContent alignItemWithTrigger={false}>
                      <SelectGroup>
                        {STATUSES.map(status => (
