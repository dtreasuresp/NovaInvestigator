  ...
  return (
    <div className='w-full max-w-3xl mx-auto px-3 sm:px-4 pb-3 pt-1 shrink-0'>
      ...
      {isNotAllowed ? (
        ...
        <div className='mb-2.5 p-3 rounded-2xl border border-chart-4/30 bg-chart-4/10 text-xs text-chart-4 flex items-center gap-2 shadow-xs'>
          <Lock className='size-4 shrink-0 text-chart-4' />
      ...
      <PromptInput
        ...
        className='w-full rounded-2xl border border-border bg-card shadow-xs transition-all'
      >
        <PromptInputTextarea
          value={input}
          ...
          <PromptInputTools className='flex items-center gap-2 flex-wrap'>
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className='flex flex-col'>
                          <span>{def.title}</span>
                          <span className='text-xs text-muted-foreground line-clamp-1'>{def.description}</span>
                        </div>
                      </DropdownMenuItem>
                    )
                  })}
            ...
            {quota && (
              <Badge
                ...
                className='h-7 px-2.5 gap-1.5 rounded-full text-xs font-mono border border-border/40 shadow-2xs shrink-0'
              >
                <Zap className='size-3 text-chart-4 shrink-0' />
                <span>
                  {!quota.allowed
                    ? 'Sin cuota'
                ...
                {dailyLim !== null && (
                  <span className='opacity-75 text-xs pl-1 border-l border-current/20'>
      ...
      <p className='mt-2 text-center text-xs text-muted-foreground/60 select-none'>
