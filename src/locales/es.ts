...
export const es: TranslationSchema = {
  ...
  novai: {
    ...
    aiWelcomeMessage: '¡Hola! Soy NovAi, tu asistente de NovaStore. Puedo analizar tus investigaciones, explicarte estrategias, validar la coherencia de tus ponderaciones o ayudarte a formular un plan de acciones. ¿En qué te gustaría profundizar hoy?',
  ...
  nav: {
    ...
    registrationCleanup: 'Limpieza de Registros',
    pendingRegistrations: 'Registros Pendientes',
    digitalVerification: 'Verificación de Identidad Digital (VID)',
    reviewQueue: 'Cola de Revisión',
    platformBilling: 'Facturación de Plataforma',
    ...
    brandSubtitle: 'Plataforma de Administración',
  ...
  pricingPage: {
    ...
    catInvestigator: 'App NovaInvestigador',
    ...
    featNovaiAccessDesc: 'Asistente conversacional para toda NovaStore (Investigador, Kanban).',
    ...
    planTrialDesc: 'Una sesión completa gratuita para probar NovaStore sin tarjeta de crédito.',
  ...
  roles: {
    ...
    allRolesTitle: 'Todos los roles de NovaStore',
  ...
  permissions: {
    ...
    savePermissions: 'Guardar permisos',
    rolesTitle: 'Roles',
    rolesDesc: 'Selecciona cualquier rol de NovaStore para consultar o editar sus capacidades.',
